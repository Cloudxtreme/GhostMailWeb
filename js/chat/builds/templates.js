...
__p += '\n        <textarea type="text" spellcheck="true" class="chat-textarea" \n            placeholder="' +
...
__p += '\n        <textarea\n            type="text"\n            class="chat-textarea" spellcheck="true"\n            placeholder="' +
...
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<div class="chat-message ' + ((__t = (extra_classes)) == null ? '' : __t) +
'msg-from-'+((__t=(sender))==null?'':__t)+'">\n'+        
'<span class="chat-message-' + ((__t = (sender)) == null ? '' : __t) + '">' +
((__t=(username.replace(/@.*$/,'')))==null?'':__t)+':&nbsp;'+
'</span>\n '+
'<span class="chat-message-content">'+((__t=(message))==null?'':__t)+
'</span>\n'+
'<div class="chat-message-time">'+
((__t=(moment().format('HH:mm')))==null?'':__t)+
'</div>\n'+
'</div>\n';
...
((__t = (title_fullname.replace(/@.*$/,''))) == null ? '' : __t) +
': ' +
((__t = (fullname.replace(/@.*$/,''))) == null ? '' : __t) +
'\nJID: ' +
((__t = (jid)) == null ? '' : __t) +
