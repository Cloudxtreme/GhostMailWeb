...
//            console.log(base64Url);
        ...
        function toArray(typedArray) {
            ...
            // Fixed large data causing javascript memory heap issues using Array.apply
            var arr = new Array();
            for(var i = 0; i < typedArray.length; i++) {
                arr.push(typedArray[i]);
            }
            return arr;//(typedArray.length === 1) ? [typedArray[0]] : Array.apply(null, typedArray);
        }
...
//            console.log('msrcryptoCbc.importKey');
//            console.log(p);
            var keyObject = msrcryptoJwk.jwkToKey(p.keyData, p.algorithm, ["k"]);
//            console.log(keyObject);
    ...
    rsaMode.oaep = function (keyStruct, hashFunction) {
        ...
        function pad(/*@type(Array)*/ message, label) {
        ...
        function unpad(/*@type(Array)*/ encodedBytes, labelBytes) {
        ...
        return {
            ...
            pad: function (/*@type(Array)*/ messageBytes, labelBytes) {
                return pad(messageBytes, labelBytes);
            },

            unpad: function (/*@type(Array)*/ encodedBytes, labelBytes) {
    ...
    rsaMode.pss = function (keyStruct, hashFunction) {
        ...
        function emsa_pss_verify( /*@type(Array)*/ signatureBytes,/*@type(Array)*/ messageBytes, saltLength) {
    ...
    var msrcryptoRsa = function (keyStruct, mode, hashFunction) {
        ...
        var returnObj = {
            ...
            encrypt: function (/*@type(Array)*/ dataBytes, labelBytes) {
            ...
            decrypt: function (/*@type(Array)*/ cipherBytes, labelBytes) {
            ...
            signData: function (/*@type(Array)*/ messageBytes, saltLength, salt) {

                return rsaBase.decrypt(paddingFunction(messageBytes, saltLength, salt));
            },

            verifySignature: function (/*@type(Array)*/ signature, /*@type(Array)*/ messageBytes, saltLength) {
    ...
    if (typeof operations !== "undefined") {
        ...
        msrcryptoRsa.generateKey = function (p) {

            var keyLength = p.algorithm.modulusLength;
            ...
            KRYPTOS.utils.log('KRYPTOS.RSA test');
            var rsa = KRYPTOS.utils.rsa();//msrcryptoUtilities.rsaKey();
            KRYPTOS.utils.log(KRYPTOS.utils.ab2hex(p.publicExponent));
            rsa.generate(keyLength, KRYPTOS.utils.ab2hex(p.publicExponent));
            KRYPTOS.utils.log(rsa);
            return {
                type: "keyGeneration",
                keyData: msrcryptoPseudoRandom.getBytes(keyLength),
                keyHandle: {
        ...
        msrcryptoRsa.importKey = function (p) {
            ...
            return {
                ...
                keyHandle: {
                    algorithm: p.algorithm,
                    extractable: p.extractable || keyObject.extractable,
                    keyUsage: null || p.keyUsages, // IE11 returns null here
...
//        operations.register("generateKey", "rsassa-pkcs1-v1_5", msrcryptoRsa.generateKey);
//        operations.register("generateKey", "rsa-oaep", msrcryptoRsa.generateKey);
...
//                console.log('buildParameterCollection');
...
//                    console.log(actualParam);
                    ...
                    if (msrcryptoUtilities.getObjectType(actualParam) !== expectedParam.type) {
                        //continue;//throw new Error(expectedParam.name);
                    }
...
//                console.log(pc);
    ...
    var publicMethods = {
        ...
        toBase64: function (data, toBase64Url) {
            ...
            return msrcryptoUtilities.toBase64(data, toBase64Url); // Fixed hardcoded boolean (false)
        },
        ...
        rsaKey: function() {
            return msrcryptoUtilities.rsaKey();
        },
